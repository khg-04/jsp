...
<body>
	...
	<form action="./proc/modify.jsp" method="post">
		<table border="1">
			...
			<tr>
				<td>name</td>
				<td><input type="text" name="name" value="<%= user2.getName() %>" placeholder="input name"></td>
			</tr>
			<tr>
				<td>birth</td>
				<td><input type="text" name="birth" value="<%= user2.getBirth() %>" placeholder="input birth"></td>
			</tr>
			<tr>
				<td>addr</td>
				<td><input type="text" name="addr" value="<%= user2.getAddr() %>" placeholder="input addr"></td>
			</tr>
			<tr>
